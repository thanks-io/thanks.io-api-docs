...
description: "Event will fire whenever an Recipient's Order Item (Mail Piece) changes status. An order item represents the details of an individual mail piece sent to a recipient."
---
