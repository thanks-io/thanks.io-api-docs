...
<Columns cols={3}>
    <Card href="/native-integrations/available/n8n" title="n8n" cta="Explore">
      Automate thanks.io inside n8n workflows with our official nodes
     </Card>
...
<Columns cols={3}>
    <Card href="https://www.pabbly.com/connect/integrations/Thanks.io/" title="Pabbly" cta="Connect">
     ...
     <Card href="https://viasocket.com/integrations/thanksio?utm_source=thanksio&utm_medium=marketplace&utm_campaign=thanksio_listing" title="viaSocket" cta="Connect">
      Create integrations between thanks.io and your favorite apps
     </Card>
  <Card href="https://help.thanks.io/integrations/suresend/" title="Sure Send"  cta="Connect">
...
<Columns cols={3}>
    <Card href="https://help.thanks.io/integrations/highlevel/" title="HighLevel"  cta="Connect">
      <Tip>Popular</Tip>
...
<Columns cols={3}>
    <Card href="https://help.thanks.io/integrations/bold-trail-kvcore" title="Bold Trail/kvCORE"  cta="Connect">
      Integrate thanks.io with Bold Trail/kvCORE
     </Card>
</Columns>
...
<Columns cols={3}>
  ...
  [Watch demo](https://www.youtube.com/watch?v=StN62Gp6Nbs)
     </Card>
</Columns>
...
<Columns cols={3}>
    <Card href="https://help.thanks.io/integrations/email-integration/" title="Email" cta="Connect">
