...
<Columns cols={3}>
  ...
  <Card href="https://help.thanks.io/sure-send-thanks.io-setup" title="Sure Send"  cta="Connect">
...
<Columns cols={3}>
    <Card href="https://help.thanks.io/highlevel" title="HighLevel"  cta="Connect">
      <Tip>Popular</Tip>
...
<Columns cols={3}>
    <Card href="https://help.thanks.io/integrating-boldtrail-with-thanks.io" title="Bold Trail/kvCORE"  cta="Connect">
